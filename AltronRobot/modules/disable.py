...
if is_module_loaded(FILENAME):
        ...
        if len(args) >= 1:
            ...
            if disable_cmd in set(DISABLE_CMDS + DISABLE_OTHER):
                ...
                update.effective_message.reply_text(
                    f"» ᴅɪꜱᴀʙʟᴇᴅ ᴛʜᴇ ᴜꜱᴇ ᴏꜰ `{disable_cmd}`",
    ...
    def disable_module(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            ...
            if disabled_cmds:
                ...
                update.effective_message.reply_text(
                    f"» ᴅɪꜱᴀʙʟᴇᴅ ᴛʜᴇ ᴜꜱᴇꜱ ᴏꜰ `{disabled_cmds_string}`",
                    parse_mode=ParseMode.MARKDOWN,
                )
    ...
    def enable(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            ...
            if sql.enable_command(chat.id, enable_cmd):
                update.effective_message.reply_text(
                    f"» ᴇɴᴀʙʟᴇᴅ ᴛʜᴇ ᴜꜱᴇ ᴏꜰ `{enable_cmd}`", parse_mode=ParseMode.MARKDOWN
                )
            else:
    ...
    def enable_module(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            ...
            if enabled_cmds:
                ...
                update.effective_message.reply_text(
                    f"» ᴇɴᴀʙʟᴇᴅ ᴛʜᴇ ᴜꜱᴇꜱ ᴏꜰ `{enabled_cmds_string}`",
                    parse_mode=ParseMode.MARKDOWN,
                )
    ...
    def list_cmds(update: Update, context: CallbackContext):
        if DISABLE_CMDS + DISABLE_OTHER:
            ...
            update.effective_message.reply_text("» ɴᴏ ᴄᴏᴍᴍᴀɴᴅꜱ ᴄᴀɴ ʙᴇ ᴅɪꜱᴀʙʟᴇᴅ.")

    # do not async
    def build_curr_disabled(chat_id: Union[str, int]) -> str:
        disabled = sql.get_all_disabled(chat_id)
        if not disabled:
            return "» ɴᴏ ᴄᴏᴍᴍᴀɴᴅꜱ ᴀʀᴇ ᴅɪꜱᴀʙʟᴇᴅ!"
