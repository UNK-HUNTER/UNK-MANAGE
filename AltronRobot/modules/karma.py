...
from AltronRobot.utils.permissions import adminsOnly
...
async def karma(_, message):
    ...
    if not message.reply_to_message:
        m = await message.reply_text("» ᴀɴᴀʟʏᴢɪɴɢ ᴋᴀʀᴍᴀ...ᴡɪʟʟ ᴛᴀᴋᴇ 10 ꜱᴇᴄᴏɴᴅꜱ")
...
async def captcha_state(_, message):
    ...
    if state == "on":
        ...
        await message.reply_text("» ᴇɴᴀʙʟᴇᴅ ᴋᴀʀᴍᴀ ꜱʏꜱᴛᴇᴍ.")
    elif state == "off":
        karma_off(chat_id)
        await message.reply_text("» ᴅɪꜱᴀʙʟᴇᴅ ᴋᴀʀᴍᴀ ꜱʏꜱᴛᴇᴍ.")
    else:
