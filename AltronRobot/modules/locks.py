...
import AltronRobot.modules.sql.locks_sql as sql
        ...
        if len(args) >= 1:
            ...
            if ltype in LOCK_TYPES:
                ...
                if conn:
                    ...
                    text = "» ʟᴏᴄᴋᴇᴅ {} ꜰᴏʀ ɴᴏɴ-ᴀᴅᴍɪɴꜱ ɪɴ {}!".format(ltype, chat_name)
                else:
                ...
                if conn:
                    ...
                    chat_id = conn
                    chat_name = chat.title
                    text = "» ʟᴏᴄᴋᴇᴅ {} ꜰᴏʀ ᴀʟʟ ɴᴏɴ-ᴀᴅᴍɪɴꜱ ɪɴ {}!".format(
                        ltype, chat_name
                    )
                else:
                    if update.effective_message.chat.type == "private":
                    ...
                    chat_id = update.effective_chat.id
                    chat_name = update.effective_message.chat.title
                    text = "» ʟᴏᴄᴋᴇᴅ {} ꜰᴏʀ ᴀʟʟ ɴᴏɴ-ᴀᴅᴍɪɴꜱ!".format(ltype)
        ...
        if len(args) >= 1:
            ...
            if ltype in LOCK_TYPES:
                ...
                if conn:
                    ...
                    chat_id = conn
                    chat_name = chat.title
                    text = "» ᴜɴʟᴏᴄᴋᴇᴅ {} ꜰᴏʀ ᴇᴠᴇʀʏᴏɴᴇ ɪɴ {}!".format(ltype, chat_name)
                else:
                    if update.effective_message.chat.type == "private":
                        send_message(
                            update.effective_message,
                    ...
                    chat_id = update.effective_chat.id
                    chat_name = update.effective_message.chat.title
                    text = "» ᴜɴʟᴏᴄᴋᴇᴅ {} ꜰᴏʀ ᴇᴠᴇʀʏᴏɴᴇ!".format(ltype)
            ...
            if lockable == "bots":
                ...
                for new_mem in new_members:
                    if new_mem.is_bot:
                        ...
                        send_message(
                            update.effective_message,
                            "» ᴏɴʟʏ ᴀᴅᴍɪɴꜱ ᴀʀᴇ ᴀʟʟᴏᴡᴇᴅ ᴛᴏ ᴀᴅᴅ ʙᴏᴛꜱ ɪɴ ᴛʜɪꜱ ᴄʜᴀᴛ! ɢᴇᴛ ᴏᴜᴛᴛᴀ ʜᴇʀᴇ.",
                        )
                        break
            else:
                try:
...
def build_lock_message(chat_id):
    ...
    permslist = []
    if locks:
        res += "» *ᴛʜᴇꜱᴇ ᴀʀᴇ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ʟᴏᴄᴋꜱ ɪɴ ᴛʜɪꜱ ᴄʜᴀᴛ:*"
    ...
    if locklist:
        ...
        for x in locklist:
            res += "\n • {}".format(x)
    res += "\n\n» *ᴛʜᴇꜱᴇ ᴀʀᴇ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴄʜᴀᴛ ᴘᴇʀᴍɪꜱꜱɪᴏɴꜱ:*"
    for x in permslist:
        res += "\n • {}".format(x)
    return res
...
def list_locks(update, context):
    ...
    if conn:
        res = res.replace("ʟᴏᴄᴋꜱ ɪɴ", "*{}*".format(chat_name))
...
__help__ = """
‣ ᴅᴏ ꜱᴛɪᴄᴋᴇʀꜱ ᴀɴɴᴏʏ ʏᴏᴜ? ᴏʀ ᴡᴀɴᴛ ᴛᴏ ᴀᴠᴏɪᴅ ᴘᴇᴏᴘʟᴇ ꜱʜᴀʀɪɴɢ ʟɪɴᴋꜱ? ᴏʀ ᴘɪᴄᴛᴜʀᴇꜱ? ʏᴏᴜ'ʀᴇ ɪɴ ᴛʜᴇ ʀɪɢʜᴛ ᴘʟᴀᴄᴇ!

‣ ᴛʜᴇ ʟᴏᴄᴋꜱ ᴍᴏᴅᴜʟᴇ ᴀʟʟᴏᴡꜱ ʏᴏᴜ ᴛᴏ ʟᴏᴄᴋ ᴀᴡᴀʏ ꜱᴏᴍᴇ ᴄᴏᴍᴍᴏɴ ɪᴛᴇᴍꜱ ɪɴ ᴛʜᴇ ᴛᴇʟᴇɢʀᴀᴍ ᴡᴏʀʟᴅ; ᴛʜᴇ ʙᴏᴛ ᴡɪʟʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇ ᴛʜᴇᴍ!

  ➲ /locktypes: ʟɪꜱᴛꜱ ᴀʟʟ ᴘᴏꜱꜱɪʙʟᴇ ʟᴏᴄᴋᴛʏᴘᴇꜱ
 
𝗔𝗱𝗺𝗶𝗻𝘀 𝗼𝗻𝗹𝘆:
  ➲ /lock <type>: ʟᴏᴄᴋ ɪᴛᴇᴍꜱ ᴏꜰ ᴀ ᴄᴇʀᴛᴀɪɴ ᴛʏᴘᴇ (ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴘʀɪᴠᴀᴛᴇ)
  ➲ /unlock <type>: ᴜɴʟᴏᴄᴋ ɪᴛᴇᴍꜱ ᴏꜰ ᴀ ᴄᴇʀᴛᴀɪɴ ᴛʏᴘᴇ (ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴘʀɪᴠᴀᴛᴇ)
  ➲ /locks: ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ʟɪꜱᴛ ᴏꜰ ʟᴏᴄᴋꜱ ɪɴ ᴛʜɪꜱ ᴄʜᴀᴛ.
 
‣ ʟᴏᴄᴋꜱ ᴄᴀɴ ʙᴇ ᴜꜱᴇᴅ ᴛᴏ ʀᴇꜱᴛʀɪᴄᴛ ᴀ ɢʀᴏᴜᴘ'ꜱ ᴜꜱᴇʀꜱ.
*ᴇɢ:*
  ‣ ʟᴏᴄᴋɪɴɢ ᴜʀʟꜱ ᴡɪʟʟ ᴀᴜᴛᴏ-ᴅᴇʟᴇᴛᴇ ᴀʟʟ ᴍᴇꜱꜱᴀɢᴇꜱ ᴡɪᴛʜ ᴜʀʟꜱ, ʟᴏᴄᴋɪɴɢ ꜱᴛɪᴄᴋᴇʀꜱ ᴡɪʟʟ ʀᴇꜱᴛʀɪᴄᴛ ᴀʟʟ ɴᴏɴ-ᴀᴅᴍɪɴ ᴜꜱᴇʀꜱ ꜰʀᴏᴍ ꜱᴇɴᴅɪɴɢ ꜱᴛɪᴄᴋᴇʀꜱ, ᴇᴛᴄ.
...
*⚠️ Note:*
 ...
 • ᴜɴʟᴏᴄᴋɪɴɢ ᴘᴇʀᴍɪꜱꜱɪᴏɴ *ᴘɪɴ* ᴡɪʟʟ ᴀʟʟᴏᴡ ᴍᴇᴍʙᴇʀꜱ (ɴᴏɴ-ᴀᴅᴍɪɴꜱ) ᴛᴏ ᴘɪɴ ᴀ ᴍᴇꜱꜱᴀɢᴇ ɪɴ ᴀ ɢʀᴏᴜᴘ.
"""
