...
from AltronRobot import BOT_NAME, BOT_USERNAME, OWNER_ID, telethn
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./AltronRobot/resources/fonts/*")
...
__help__ = """
‣ ɪ ᴄᴀɴ ᴄʀᴇᴀᴛᴇ ꜱᴏᴍᴇ ʙᴇᴀᴜᴛɪꜰᴜʟ ᴀɴᴅ ᴀᴛᴛʀᴀᴄᴛɪᴠᴇ ʟᴏɢᴏ ꜰᴏʀ ʏᴏᴜʀ ᴘʀᴏꜰɪʟᴇ ᴘɪᴄꜱ.

  ➲ /logo <Text> : ᴄʀᴇᴀᴛᴇ ᴀ ʟᴏɢᴏ ᴏꜰ ʏᴏᴜʀ ɢɪᴠᴇɴ ᴛᴇxᴛ ᴡɪᴛʜ ʀᴀɴᴅᴏᴍ ᴠɪᴇᴡ.
"""
