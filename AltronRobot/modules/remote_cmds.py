...
from AltronRobot import dispatcher, LOGGER
...
from AltronRobot.modules.helper_funcs.extraction import extract_user_and_text
...
def rban(update: Update, context: CallbackContext):
    ...
    try:
        ...
        message.reply_text("» ʙᴀɴɴᴇᴅ ꜰʀᴏᴍ ᴄʜᴀᴛ!")
    except BadRequest as excp:
...
def runban(update: Update, context: CallbackContext):
    ...
    try:
        ...
        message.reply_text("» ʏᴇᴘ, ᴛʜɪꜱ ᴜꜱᴇʀ ᴄᴀɴ ᴊᴏɪɴ ᴛʜᴀᴛ ᴄʜᴀᴛ!")
    except BadRequest as excp:
        if excp.message == "Reply message not found":
            ...
            message.reply_text("» ᴡᴇʟʟ ᴅᴀᴍɴ, ɪ ᴄᴀɴ'ᴛ ᴜɴʙᴀɴ ᴛʜᴀᴛ ᴜꜱᴇʀ.")
...
def rkick(update: Update, context: CallbackContext):
    ...
    try:
        chat.unban_member(user_id)
        message.reply_text("» ᴘᴜɴᴄʜᴇᴅ ꜰʀᴏᴍ ᴄʜᴀᴛ!")
    except BadRequest as excp:
        if excp.message == "Reply message not found":
            # Do not reply
...
def rmute(update: Update, context: CallbackContext):
    ...
    try:
        ...
        message.reply_text("» ᴍᴜᴛᴇᴅ ꜰʀᴏᴍ ᴛʜᴇ ᴄʜᴀᴛ!")
    except BadRequest as excp:
        if excp.message == "Reply message not found":
            # Do not reply
            message.reply_text("ᴍᴜᴛᴇᴅ!", quote=False)
...
def runmute(update: Update, context: CallbackContext):
    ...
    try:
        ...
        if excp.message == "Reply message not found":
            # Do not reply
            message.reply_text("ᴜɴᴍᴜᴛᴇᴅ!", quote=False)
            ...
            message.reply_text("» ᴡᴇʟʟ ᴅᴀᴍɴ, ɪ ᴄᴀɴ'ᴛ ᴜɴᴍᴜᴛᴇ ᴛʜᴀᴛ ᴜꜱᴇʀ.")
