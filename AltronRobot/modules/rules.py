...
import AltronRobot.modules.sql.rules_sql as sql
...
def set_rules(update: Update, context: CallbackContext):
    ...
    if txt:
        ...
        update.effective_message.reply_text("» ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ꜱᴇᴛ ʀᴜʟᴇꜱ ꜰᴏʀ ᴛʜɪꜱ ɢʀᴏᴜᴘ.")
    else:
        update.effective_message.reply_text("» ᴛʜᴇʀᴇ'ꜱ... ɴᴏ ʀᴜʟᴇꜱ?")
...
__help__ = """
 ...
 ➲ /rules here : ɢᴇᴛ ᴛʜᴇ ʀᴜʟᴇꜱ ꜰᴏʀ ᴛʜɪꜱ ᴄʜᴀᴛ ʙᴜᴛ ꜱᴇɴᴅ ɪᴛ ɪɴ ᴛʜᴇ ᴄʜᴀᴛ.
