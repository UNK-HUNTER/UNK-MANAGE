...
def stickerid(update: Update, context: CallbackContext):
    ...
    if msg.reply_to_message and msg.reply_to_message.sticker:
        update.effective_message.reply_text(
            f"» ʜᴇʟʟᴏ {mention_html(msg.from_user.id, msg.from_user.first_name)}, ᴛʜᴇ ꜱᴛɪᴄᴋᴇʀ ɪᴅ ʏᴏᴜ ᴀʀᴇ ʀᴇᴘʟʏɪɴɢ ɪꜱ :\n <code>{escape(msg.reply_to_message.sticker.file_id)}</code>",
            parse_mode=ParseMode.HTML,
        )
    else:
        update.effective_message.reply_text(
            f"» ʜᴇʟʟᴏ {mention_html(msg.from_user.id, msg.from_user.first_name)}, ᴘʟᴇᴀꜱᴇ ʀᴇᴘʟʏ ᴛᴏ ꜱᴛɪᴄᴋᴇʀ ᴍᴇꜱꜱᴀɢᴇ ᴛᴏ ɢᴇᴛ ɪᴅ ꜱᴛɪᴄᴋᴇʀ.",
            parse_mode=ParseMode.HTML,
        )
...
def kang(update: Update, context: CallbackContext):
    ...
    args = context.args
    packnum = 0
    packname = "M" + str(user.id) + "_by_" + context.bot.username
    packname_found = 0
    max_stickers = 120
    ...
    if msg.reply_to_message:
        ...
        packs = "» ᴘʟᴇᴀꜱᴇ ʀᴇᴘʟʏ ᴛᴏ ᴀ ꜱᴛɪᴄᴋᴇʀ, ᴏʀ ɪᴍᴀɢᴇ ᴛᴏ ᴋᴀɴɢ ɪᴛ!\n» ʜᴇʀᴇ ᴀʀᴇ ʏᴏᴜʀ ᴘᴀᴄᴋꜱ:\n"
        if packnum > 0:
...
def makepack_internal(
    ...
    try:
        ...
        if e.message == "Sticker set name is already occupied":
            ...
            msg.reply_text(
                    "» ꜱᴛɪᴄᴋᴇʀ ᴘᴀᴄᴋ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴄʀᴇᴀᴛᴇᴅ.",
                    reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton("• ᴠɪᴇᴡ ᴘᴀᴄᴋ •", url=f"https://t.me/addstickers/{packname}")]]
                    )
                )
    ...
    if success:
        ...
        msg.reply_text("Failed to create sticker pack. Possibly due to black magic.")
