...
async def _(event):
    ...
    if not (reply and (reply.media)):
        await event.reply("» ᴘʟᴇᴀꜱᴇ ʀᴇᴘʟʏ ᴛᴏ ᴀ ꜱᴛɪᴄᴋᴇʀ")
        return
    kontol = await event.reply("» ᴘʀᴏᴄᴇꜱꜱɪɴɢ ᴛɪɴʏ...")
    ik = await telethn.download_media(reply)
    im1 = Image.open("AltronRobot/resources/blank_background.png")
    if ik.endswith(".tgs"):
        await telethn.download_media(reply, "blank_background.tgs")
...
__mod_name__ = "Tɪɴʏ"
__help__ = """
 ➲ /tiny : ʀᴇᴘʟʏ ᴀ ꜱᴛɪᴄᴋᴇʀ ᴛᴏ ᴍᴀᴋᴇ ɪᴛ ꜱᴍᴀʟʟ
"""
