...
from AltronRobot import TEMP_DOWNLOAD_DIRECTORY
...
async def _(event):
    ...
    mone = await event.reply("⏳️ ᴘʟᴇᴀꜱᴇ ᴡᴀɪᴛ...")
...
async def _(event):
    ...
    mone = await event.reply("ᴜɴᴢɪᴘᴘɪɴɢ...")
    if not os.path.isdir(TEMP_DOWNLOAD_DIRECTORY):
        os.makedirs(TEMP_DOWNLOAD_DIRECTORY)
    if event.reply_to_msg_id:
        start = datetime.now()
            ...
            if os.path.exists(single_file):
                ...
                try:
                    ...
                    await telethn.send_message(
                        event.chat_id,
                        "{} ᴄᴀᴜꜱᴇᴅ `{}`".format(caption_rts, str(e)),
                        reply_to=event.message.id,
                    )
                    continue
...
__help__ = """
‣ ʜᴇʏ ɪ ᴄᴀɴ ᴄᴏɴᴠᴇʀᴛ ꜰɪʟᴇꜱ ʜᴇʀᴇ...
 ➲ /zip : ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴛᴇʟᴇɢʀᴀᴍ ꜰɪʟᴇ ᴛᴏ ᴄᴏᴍᴘʀᴇꜱꜱ ɪᴛ ɪɴ .zip ꜰᴏʀᴍᴀᴛ
